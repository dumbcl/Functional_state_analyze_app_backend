...
from app.routes import auth, health, escal_results, escal_daily_results, gench_test, personal_report, reactions_test, rufie_test, strup_test, text_audition, daily_tests_results
